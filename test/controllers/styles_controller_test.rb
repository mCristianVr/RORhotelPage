...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post styles_url, params: { style: { cap: @style.cap, desc: @style.desc, price: @style.price } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { cap: @style.cap, desc: @style.desc, price: @style.price } }
